    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aircraft', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='flights', to='pilotlog.aircraft')),
                ('arr_airfield', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='arrivals', to='pilotlog.airfield')),
                ('dep_airfield', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='departures', to='pilotlog.airfield')),
                ('p1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='as_p1', to='pilotlog.pilot')),
                ('p2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='as_p2', to='pilotlog.pilot')),
                ('p3', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='as_p3', to='pilotlog.pilot')),
                ('p4', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='as_p4', to='pilotlog.pilot')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_modified', models.IntegerField()),
                ('ref_airfield', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='qualifications', to='pilotlog.airfield')),
            ],
            options={
                'abstract': False,
            },
